...
################################################################
# Commented out because STreversal, Price and Size are already #
# included in Signals csv                                      #
################################################################
...
# ### READ DATA
# 
# crspret  = read_fst(paste0(pathThesisData,'interim/crspmret.fst'))
# crspinfo = read_fst(paste0(pathThesisData,'interim/crspminfo.fst'))
# 
# ### MAKE STreversal
